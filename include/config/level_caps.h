...
//set B_LEVEL_CAP_VARIABLE to VAR_LEVEL_CAP to have it automatically set level caps
// this ^ is untested AND using near base game level caps; may need to adjust the function
