...
// In-game Trade IDs
#define INGAME_TRADE_MEOWTH 0
#define INGAME_TRADE_PLUSLE 1
#define INGAME_TRADE_HORSEA 2
#define INGAME_TRADE_MEOWTHO 3
#define INGAME_TRADE_RATTATA_ALOLA 4
#define INGAME_TRADE_SANDSHREW_ALOLA 5
#define INGAME_TRADE_VULPIX_ALOLA 6
#define INGAME_TRADE_DIGLETT_ALOLA 7
#define INGAME_TRADE_MEOWTH_ALOLA 8
#define INGAME_TRADE_GEODUDE_ALOLA 9
#define INGAME_TRADE_GRIMER_ALOLA 10
#define INGAME_TRADE_RAICHU_ALOLA 11
#define INGAME_TRADE_EXEGGUTOR_ALOLA 12
#define INGAME_TRADE_MAROWAK_ALOLA 13
