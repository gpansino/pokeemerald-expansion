...
static const u8 sRegionMapSectionId_To_PopUpThemeIdMapping[] =
{
    ...
    [MAPSEC_WISHING_ROAD] = MAPPOPUP_THEME_MARBLE,
    [MAPSEC_STAR_CAVE] = MAPPOPUP_THEME_MARBLE,
    [MAPSEC_MILLENIUM_FESTIVAL] = MAPPOPUP_THEME_MARBLE,
    [MAPSEC_FORINA] = MAPPOPUP_THEME_WOOD,
