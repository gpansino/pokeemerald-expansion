static const struct HealLocation sHealLocations[] =
{
    ...
    [HEAL_LOCATION_LA_ROUSSE_CITY - 1] = {MAP_GROUP(LA_ROUSSE_CITY), MAP_NUM(LA_ROUSSE_CITY), 4, 54},
    [HEAL_LOCATION_MILLENIUM_FESTIVAL - 1] = {MAP_GROUP(MILLENIUM_FESTIVAL), MAP_NUM(MILLENIUM_FESTIVAL), 14, 15},
};
