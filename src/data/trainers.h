const struct Trainer gTrainers[] = {
    ...
    [TRAINER_DALE] =
    {
        ...
        .items = {},
        .doubleBattle = FALSE,
        .aiFlags = AI_FLAG_CHECK_BAD_MOVE | AI_FLAG_RISKY | AI_FLAG_CHECK_VIABILITY,
    ...
    [TRAINER_EDMOND] =
    {
        ...
        .items = {},
        .doubleBattle = FALSE,
        .aiFlags = AI_FLAG_CHECK_BAD_MOVE | AI_FLAG_CHECK_VIABILITY | AI_FLAG_RISKY,
    ...
    [TRAINER_KAILANI] =
    {
        ...
        .encounterMusic_gender = F_TRAINER_FEMALE | TRAINER_ENCOUNTER_MUSIC_FEMALE,
        .trainerPic = TRAINER_PIC_AROMA_LADY,
        .trainerName = _("KAILANI"),
        .items = {},
        .doubleBattle = FALSE,
        .aiFlags = 0,
        .partySize = ARRAY_COUNT(sParty_Kailani),
        .party = {.TrainerMon = sParty_Kailani},
    },

    [TRAINER_STEVEN_GRANITECAVE] = 
    {
        .trainerClass = TRAINER_CLASS_PKMN_TRAINER_1,
        .encounterMusic_gender = TRAINER_ENCOUNTER_MUSIC_MALE,
        .trainerPic = TRAINER_PIC_STEVEN,
        ...
        .partySize = ARRAY_COUNT(sParty_StevenGranite),
        .party = {.TrainerMon = sParty_StevenGranite},
    }
};
