...
static const u8 sThunderArmorDescription[] = _("Gets boost from electricity.");
...
const u8 gAbilityNames[ABILITIES_COUNT][ABILITY_NAME_LENGTH + 1] =
{
    ...
    [ABILITY_THUNDER_ARMOR] = _("THUNDER ARMOR"),
};
#else   // 12 characters
const u8 gAbilityNames[ABILITIES_COUNT][ABILITY_NAME_LENGTH + 1] =
{
    ...
    [ABILITY_THUNDER_ARMOR] = _("THUNDERARMOR"),
};
#endif
...
const u8 *const gAbilityDescriptionPointers[ABILITIES_COUNT] =
{
    ...
    [ABILITY_THUNDER_ARMOR] = sThunderArmorDescription,
};
