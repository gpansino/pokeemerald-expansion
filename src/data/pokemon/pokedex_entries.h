const struct PokedexEntry gPokedexEntries[] =
{
    ...
    [NATIONAL_DEX_RATTATA_ALOLAN] =
    {
        ...
        .height = 3,
        .weight = 38,
        .description = gARattataPokedexText,
        .pokemonScale = 481,
        .pokemonOffset = 21,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_RATICATE_ALOLAN] =
    {
        ...
        .height = 7,
        .weight = 255,
        .description = gARaticatePokedexText,
        .pokemonScale = 459,
        .pokemonOffset = 18,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    {
        .categoryName = _("Pancake"),
        .height = 7,
        .weight = 210,
        .description = gARaichuPokedexText,
        .pokemonScale = 426,
        .pokemonOffset = 13,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    {
        .categoryName = _("Curling"),
        .height = 7,
        .weight = 400,
        .description = gASandshrewPokedexText,
        .pokemonScale = 365,
        .pokemonOffset = 18,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_SANDSLASH_ALOLAN] =
    {
        ...
        .height = 12,
        .weight = 550,
        .description = gASandslashPokedexText,
        .pokemonScale = 341,
        .pokemonOffset = 11,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_VULPIX_ALOLAN] =
    {
        ...
        .height = 6,
        .weight = 99,
        .description = gAVulpixPokedexText,
        .pokemonScale = 542,
        .pokemonOffset = 19,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_NINETALES_ALOLAN] =
    {
        ...
        .height = 11,
        .weight = 199,
        .description = gANinetalesPokedexText,
        .pokemonScale = 339,
        .pokemonOffset = 10,
        .trainerScale = 256,
        .trainerOffset = 0,
      ...
      [NATIONAL_DEX_DIGLETT_ALOLAN] =
    {
        ...
        .height = 2,
        .weight = 10,
        .description = gADiglettPokedexText,
        .pokemonScale = 833,
        .pokemonOffset = 25,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_DUGTRIO_ALOLAN] =
    {
        ...
        .height = 7,
        .weight = 666,
        .description = gADugtrioPokedexText,
        .pokemonScale = 406,
        .pokemonOffset = 18,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    {
        .categoryName = _("Royal Pride"),
        .height = 4,
        .weight = 42,
        .description = gAMeowthPokedexText,
        .pokemonScale = 480,
        .pokemonOffset = 19,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_PERSIAN_ALOLAN] =
    {
        ...
        .height = 11,
        .weight = 330,
        .description = gAPersianPokedexText,
        .pokemonScale = 320,
        .pokemonOffset = 10,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_GEODUDE_ALOLAN] =
    {
        ...
        .height = 4,
        .weight = 203,
        .description = gAGeodudePokedexText,
        .pokemonScale = 347,
        .pokemonOffset = 18,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_GRAVELER_ALOLAN] =
    {
        ...
        .height = 10,
        .weight = 1100,
        .description = gAGravelerPokedexText,
        .pokemonScale = 256,
        .pokemonOffset = 2,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    {
        .categoryName = _("Taser"),
        .height = 17,
        .weight = 3160,
        .description = gAGolemPokedexText,
        .pokemonScale = 256,
        .pokemonOffset = 3,
        .trainerScale = 296,
        .trainerOffset = 2,
    ...
    [NATIONAL_DEX_GRIMER_ALOLAN] =
    {
        ...
        .height = 7,
        .weight = 420,
        .description = gAGrimerPokedexText,
        .pokemonScale = 258,
        .pokemonOffset = 10,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_EXEGGUTOR_ALOLAN] =
    {
        ...
        .height = 109,
        .weight = 4156,
        .description = gAExeggutorPokedexText,
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 309,
        .trainerOffset = 5,
    ...
    [NATIONAL_DEX_MAROWAK_ALOLAN] =
    {
        ...
        .height = 10,
        .weight = 340,
        .description = gAMarowakPokedexText,
        .pokemonScale = 293,
        .pokemonOffset = 12,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_PONYTA_GALARIAN] =
    {
        ...
        .height = 8,
        .weight = 240,
        .description = gGPonytaPokedexText,
        .pokemonScale = 283,
        .pokemonOffset = 8,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_RAPIDASH_GALARIAN] =
    {
        ...
        .height = 17,
        .weight = 800,
        .description = gGRapidashPokedexText,
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 289,
        .trainerOffset = 1,
    ...
    [NATIONAL_DEX_SLOWPOKE_GALARIAN] =
    {
        ...
        .height = 12,
        .weight = 360,
        .description = gGSlowpokePokedexText,
        .pokemonScale = 256,
        .pokemonOffset = 10,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    {
        .categoryName = _("Quick Draw"),
        .height = 16,
        .weight = 705,
        .description = gGSlowbroPokedexText,
        .pokemonScale = 256,
        .pokemonOffset = 6,
        .trainerScale = 296,
        .trainerOffset = 2,
    ...
    [NATIONAL_DEX_SLOWKING_GALARIAN] =
    {
        ...
        .height = 18,
        .weight = 795,
        .description = gGSlowkingPokedexText,
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 309,
        .trainerOffset = 5,
    ...
    [NATIONAL_DEX_WEEZING_GALARIAN] =
    {
        ...
        .height = 30,
        .weight = 160,
        .description = gGWeezingPokedexText,
        .pokemonScale = 305,
        .pokemonOffset = 3,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_ZIGZAGOON_GALARIAN] =
    {
        ...
        .height = 4,
        .weight = 175,
        .description = gGZigzagoonPokedexText,
        .pokemonScale = 560,
        .pokemonOffset = 22,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_LINOONE_GALARIAN] =
    {
        ...
        .height = 5,
        .weight = 325,
        .description = gGLinoonePokedexText,
        .pokemonScale = 321,
        .pokemonOffset = 7,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_FARFETCHD_GALARIAN] =
    {
        ...
        .height = 8,
        .weight = 420,
        .description = gGFarfetchdPokedexText,
        .pokemonScale = 330,
        .pokemonOffset = 2,
        .trainerScale = 293,
        .trainerOffset = 2,
    ...
    {
        .categoryName = _("Tap Dance"),
        .height = 14,
        .weight = 568,
        .description = gGMrMimePokedexText,
        .pokemonScale = 258,
        .pokemonOffset = 6,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    {
        .categoryName = _("Solidify"),
        .height = 17,
        .weight = 509,
        .description = gGArticunoPokedexText,
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 309,
        .trainerOffset = 2,
    ...
    [NATIONAL_DEX_ZAPDOS_GALARIAN] =
    {
        ...
        .height = 16,
        .weight = 582,
        .description = gGZapdosPokedexText,
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 318,
        .trainerOffset = 3,
    ...
    {
        .categoryName = _("Fiery"),
        .height = 20,
        .weight = 660,
        .description = gGMoltresPokedexText,
        .pokemonScale = 270,
        .pokemonOffset = 0,
        .trainerScale = 387,
        .trainerOffset = 8,
