const struct Evolution gEvolutionTable[NUM_SPECIES][EVOS_PER_MON] =
{
    ...
    [SPECIES_PIKACHU]               = {{EVO_ITEM, ITEM_THUNDER_STONE, SPECIES_RAICHU},
                                       {EVO_TRADE_ITEM, ITEM_THUNDER_STONE, SPECIES_RAICHU_ALOLAN}},
    ...
    [SPECIES_EXEGGCUTE]             = {{EVO_ITEM, ITEM_LEAF_STONE, SPECIES_EXEGGUTOR},
                                       {EVO_TRADE_ITEM, ITEM_LEAF_STONE, SPECIES_EXEGGUTOR_ALOLAN}},
...
#if P_GEN_4_POKEMON == TRUE
    [SPECIES_SNEASEL]               = {{EVO_ITEM, ITEM_DUSK_STONE, SPECIES_WEAVILE}},
#endif
    [SPECIES_TEDDIURSA]             = {{EVO_LEVEL, 30, SPECIES_URSARING}},
    [SPECIES_SLUGMA]                = {{EVO_LEVEL, 38, SPECIES_MAGCARGO}},
    [SPECIES_SWINUB]                = {{EVO_LEVEL, 33, SPECIES_PILOSWINE}},
#if P_GEN_4_POKEMON == TRUE
    [SPECIES_PILOSWINE]             = {{EVO_LEVEL, 41, SPECIES_MAMOSWINE}},
#endif
...
#if P_GEN_4_POKEMON == TRUE
    [SPECIES_PORYGON2]              = {{EVO_ITEM_HOLD_DAY, ITEM_UPGRADE, SPECIES_PORYGON_Z}},
#endif
    ...
    [SPECIES_NUZLEAF]               = {{EVO_ITEM, ITEM_SUN_STONE, SPECIES_SHIFTRY}},
    ...
    [SPECIES_FEEBAS]                = {{EVO_BEAUTY, 170, SPECIES_MILOTIC},
                                       {EVO_ITEM_HOLD_DAY, ITEM_DRAGON_SCALE, SPECIES_MILOTIC}},
    ...
    [SPECIES_VULPIX_ALOLAN]         = {{EVO_ITEM, ITEM_SHINY_STONE, SPECIES_NINETALES_ALOLAN}},
