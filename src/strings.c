...
const u8 gText_NothingToCut[] = _("There's nothing to CUT.{PAUSE_UNTIL_PRESS}");
const u8 gText_CantSurfHere[] = _("You can't SURF here.");
const u8 gText_AlreadySurfing[] = _("You're already SURFING.");
const u8 gText_CantUseHere[] = _("Can't use that here.{PAUSE_UNTIL_PRESS}");
...
const u8 gText_ChooseStore[] = _("Choose a POKéMON to move to PC.");
...
const u8 gText_InUseAlready_PM[] = _("This is in use already.{PAUSE_UNTIL_PRESS}");
...
//added strings
const u8 gText_BabyQuiz1_1[] = _("Strongly Push Them");
const u8 gText_BabyQuiz1_2[] = _("Gently Encourage Them");
const u8 gText_BabyQuiz2_1[] = _("Getting Stronger");
const u8 gText_BabyQuiz2_2[] = _("Becoming Friends");
const u8 gText_BabyQuiz2_3[] = _("Having a Good Time");
const u8 gText_BabyQuiz3_1[] = _("Being Thoughtful Towards POKéMON");
const u8 gText_BabyQuiz3_2[] = _("Deepening Bonds");
const u8 gText_BabyQuiz3_3[] = _("Having Fun");
const u8 gText_BabyQuiz4_1[] = _("Focusing on Their Positives");
const u8 gText_BabyQuiz4_2[] = _("A Strong Spirit");
const u8 gText_BabyQuiz4_3[] = _("Rigirous Training");
const u8 gText_BabyQuiz5_1[] = _("A Positive Spirit");
const u8 gText_BabyQuiz5_2[] = _("Acts of Kindness");
const u8 gText_BabyQuiz5_3[] = _("Listening");
const u8 gText_BabyQuiz6_1[] = _("Great Food & Relaxation");
const u8 gText_BabyQuiz6_2[] = _("Partying Hard");
const u8 gText_BabyQuiz6_3[] = _("Positive Emotions");
const u8 gText_BabyQuiz7_1[] = _("Help the Most People");
const u8 gText_BabyQuiz7_2[] = _("Help the One's Who Need It");
const u8 gText_BabyQuiz7_3[] = _("Help the One's I Love");
const u8 gText_BabyQuiz8_1[] = _("Tenderness");
const u8 gText_BabyQuiz8_2[] = _("Lots of Fun!");
const u8 gText_BabyQuiz8_3[] = _("Fate");
const u8 gText_BabyQuiz9_1[] = _("Messing with Others");
const u8 gText_BabyQuiz9_2[] = _("Displaying my Talents");
const u8 gText_BabyQuiz9_3[] = _("Vibing");
const u8 gText_GameCornerEeveeAndPrice[] = _("EEVEE{CLEAR_TO 0x36}1,000 COINS");
const u8 gText_GameCornerPorygonAndPrice[] = _("PORYGON{CLEAR_TO 0x36}5,000 COINS");
const u8 gText_AlolanRattata[] = _("RATTATA");
const u8 gText_AlolanRaichu[] = _("RAICHU");
const u8 gText_AlolanSandshrew[] = _("SANDSHREW");
const u8 gText_AlolanVulpix[] = _("VULPIX");
const u8 gText_AlolanDiglett[] = _("DIGLETT");
const u8 gText_AlolanMeowth[] = _("MEOWTH");
const u8 gText_AlolanGeodude[] = _("GEODUDE");
...
const u8 gText_PokenavMute[] = _("Mute/Unmute POKéNAV");
