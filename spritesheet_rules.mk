...
$(OBJEVENTGFXDIR)/people/diane.4bpp: %.4bpp: %.png
	$(GFX) $< $@ -mwidth 2 -mheight 4
...
graphics/star_cave_maps/CaveMapB-0.4bpp: %.4bpp: %.png
	$(GFX) $< $@ -mwidth 8 -mheight 8

graphics/star_cave_maps/CaveMapB-1.4bpp: %.4bpp: %.png
	$(GFX) $< $@ -mwidth 8 -mheight 8

graphics/star_cave_maps/CaveMapB-2.4bpp: %.4bpp: %.png
	$(GFX) $< $@ -mwidth 8 -mheight 8

graphics/star_cave_maps/CaveMapB-3.4bpp: %.4bpp: %.png
	$(GFX) $< $@ -mwidth 8 -mheight 8
